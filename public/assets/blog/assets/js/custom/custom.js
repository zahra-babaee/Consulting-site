...
var booked_js_vars = {
	"ajax_url": "http:\/\/dentario. Mellatweb.com.net\/wp-admin\/admin-ajax.php",
	"profilePage": "",
	"publicAppointments": "",
...
if (typeof DENTARIO_STORAGE == 'undefined') var DENTARIO_STORAGE = {};
	DENTARIO_STORAGE['ajax_url'] = 'http://dentario. Mellatweb.com.net/wp-admin/admin-ajax.php';
	DENTARIO_STORAGE['ajax_nonce'] = '178c041120';
	DENTARIO_STORAGE['site_url'] = 'http://dentario. Mellatweb.com.net';
...
function initRevSlider() {
    ...
    var ajaxRevslider = function(obj) {
        ...
        jQuery.ajax({
            type: "post",
            url: "http://dentario. Mellatweb.com.net/wp-admin/admin-ajax.php",
            dataType: 'json',
            data: data,
            async: false,
    ...
    tpj(document).ready(function() {
        ...
        if (tpj("#rev_slider_1_1").revolution == undefined) {
            ...
            revapi1 = tpj("#rev_slider_1_1").show().revolution({
                sliderType: "standard",
                jsFileLocation: "//dentario. Mellatweb.com.net/wp-content/plugins/revslider/public/assets/js/",
                sliderLayout: "fullwidth",
                dottedOverlay: "none",
                delay: 7000,
                navigation: {
...
function initEssGrid(){
	...
	essapi_1 = jQuery("#esg-grid-1-1").tpessential({
		...
		loadMoreAjaxUrl: "http://dentario. Mellatweb.com.net/wp-admin/admin-ajax.php",
